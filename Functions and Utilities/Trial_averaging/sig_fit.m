...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Dynamic_IFF_fit, Dynamic_gof, Static_IFF_fit, Static_gof ] = sig_fit( Dynamic_agg, Static_agg, dataName )

%Define the sigmoid equation (a: slope, b: Lower, c: Upper, d:X50)
...
print('-bestfit',[title_name 'displacement'],'-dpdf');
