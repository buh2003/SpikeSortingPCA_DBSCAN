...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ ] = save_file(ALL_ISI_OF,StimPhase_ISI_OF,Dynamic_ISI_OF,Late_Static_ISI_OF, End_ISI_OF, Disp_points, latencies, dataName)
...
xlwrite([dataName ' analyzed.xlsx'],{'Force','Latency to Spike'},'Latencies');
xlwrite([dataName ' analyzed.xlsx'],[ALL_ISI_OF(:,5),latencies],'Latencies', 'A2');
disp('Saving.......Done!')
end
