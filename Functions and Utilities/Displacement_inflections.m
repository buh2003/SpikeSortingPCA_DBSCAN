...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ OUT01 ] = Displacement_inflections( Displacement, baseline_start, baseline_end, sat_start, sat_end )
...
for i = 1:cols
      ...
      for j = baseline_end:row
          ...
          if ((value > temp_baseline)&&(Count_start < 100))
             temp_start = j; temp_baseline = value;
             Count_start = Count_start+1;
          end
          if (Count_start==20);% When Count01 reaches 20, the point is named start point. 
              Start = temp_start; Fn01=1;
          end
