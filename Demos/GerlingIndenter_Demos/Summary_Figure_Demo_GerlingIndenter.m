...
%% Figure Title
dataName = '081017 891 fiber4';
Example_Names = ' (t1max1 t1med3 t1min4)';
...
Stim_min = 4; %% ENTER MAX STIM NUMBER HERE BEFORE YOU BEGIN
trial_Name = ''; %% ENTER TRIAL NUMBER HERE BEFORE YOU BEGIN
summary_fig_name = [dataName trial_Name ' Summary.fig'];
summary_IFF_name = [dataName trial_Name ' IFF.fig'];
...
ylim(axes4,[min(Response_max(30000:60000,1))-10 max(Response_max(30000:60000,1))+10]);
hold(axes4,'on');
axis off
...
ylim(axes5,[min(Response_max(30000:60000,1))-10 max(Response_max(30000:60000,1))+10]);
hold(axes5,'on');
