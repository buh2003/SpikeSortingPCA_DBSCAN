...
dataName = '010918 wt AM fiber4'; % add file Name!
...
[Spike_Train, Spike_Shape] = Spike_Bandpass_SNP(All_short, 1500, 50, 48); % ENTER PEAK BANDPASS
...
idx = DBSCAN(PCA_weights(:,1:2),0.005,3); % (PCA1 and PCA2, epsilon, minimum spikes per cluster)  
